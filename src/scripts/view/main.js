...
if ("serviceWorker" in navigator) {
    window.addEventListener("load", () => {
        ...
        registerEvents(registration, {
            ...
            onUpdatingFailed: () => {
                console.log("SW: onUpdatingFailed");
            },
            onUpdated: () => {
                    ...
                    navigator.serviceWorker.getRegistration()
                        .then(registration => {
                            registration.pushManager.subscribe({
                                ...
                                applicationServerKey: urlBase64ToUint8Array("BGI2ATfn34mWkKQA8UOxXq6mEH-1RGLZsFDJx3GjGLeXJ19W2_JMmnKGimTnksDpskFjIhjlyI5L64-IuCQne-I")
                            }).then(subscribe => {
